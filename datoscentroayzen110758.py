...
# ============================================================
# CENTRO: ACS15 region centro
# Locality 110758
# ============================================================

lat_centro = -45.489214
lon_centro = -74.204886
...
# Carpeta de salida
directorio_hdd = r"C:\Users\jarpa\OneDrive\Escritorio\datos tesis\Historico_110758"
os.makedirs(directorio_hdd, exist_ok=True)

print("Iniciando extracción Copernicus para ACS15 110758")
...
for anio in range(2014, 2025):
    ...
    nombre_archivo = f"ACS15_110758_temp_sal_{anio}.nc"
