...
lat_centro = -54.085578
lon_centro = -71.401003
...
# Carpeta de salida
directorio_hdd = r"C:\Users\jarpa\OneDrive\Escritorio\datos tesis\Historico_120128"
os.makedirs(directorio_hdd, exist_ok=True)

print("Iniciando extracción Copernicus para ACS 54 B 120128")
...
for anio in range(2014, 2025):
    ...
    nombre_archivo = f"ACS_54_B_120128_temp_sal_{anio}.nc"
