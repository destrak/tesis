...
# ============================================================
# CENTRO: Espnestar region centro
# Locality 32677
# ============================================================

lat_centro = 63.677883
lon_centro = 8.667
...
# Carpeta de salida
directorio_hdd = r"C:\Users\jarpa\OneDrive\Escritorio\datos tesis\Historico_32677"
os.makedirs(directorio_hdd, exist_ok=True)

print("Iniciando extracción Copernicus para The Espnestar 32677")
...
for anio in range(2014, 2025):
    ...
    nombre_archivo = f"Espnestar_32677_temp_sal_{anio}.nc"
