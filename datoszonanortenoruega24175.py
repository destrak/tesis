...
# ============================================================
# CENTRO: Outer Lavollsfjord
# Locality  24175
# ============================================================

lat_centro = 69.419467
lon_centro = 17.287567	
...
# Carpeta de salida
directorio_hdd = r"C:\Users\jarpa\OneDrive\Escritorio\datos tesis\Historico_24175"
os.makedirs(directorio_hdd, exist_ok=True)

print("Iniciando extracción Copernicus para Outer Lavollsfjord 24175")
...
for anio in range(2014, 2025):
    ...
    nombre_archivo = f"Outer_Lavollsfjord_24175_temp_sal_{anio}.nc"
